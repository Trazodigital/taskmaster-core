...
**TYPE:** ARCH
**ORIGIN:** sequence Flow 1: alt storage unavailable

**STATEMENT:** A failed `persist task` write SHALL surface to the User as an explicit error rather than a silent success.
